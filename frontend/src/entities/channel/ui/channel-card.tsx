	...
	return (
		...
		>
			<div className='relative z-20 flex h-full flex-col gap-y-4'>
				<h3 className='select-none text-2xl tracking-[-2%]'>{name ?? 'Без названия'}</h3>
				<div className='mt-auto flex flex-col gap-y-2 tracking-default'>
					...
					<p className='flex h-6 items-center gap-x-1'>
						<span className='text-2xl font-semibold text-tiny-900'>{participantCount}</span>
						<span className='text-base font-bold text-tiny-900/40'>/</span>
						<span className='text-2xl font-semibold text-tiny-900/40'>{maxParticipants}</span>
					</p>
				</div>
