...
export const ChannelCard = ({ className, onClick }: { className?: string; onClick?: VoidFunction }) => {
	return (
		<article
		...
		>
			<div className='relative z-20 flex h-full flex-col gap-y-4'>
				<h3 className='select-none text-2xl tracking-[-2%]'>Созвон корпоратов и прочих людей</h3>
